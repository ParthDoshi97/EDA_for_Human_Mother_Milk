...
# summary Stats
skimmed_FAMES <- skim_to_wide(FAMES.HM.Data)
skimmed_FAMES
...
```{r}
# Log Transformation 
FAMES.HM.Data.Normal <- log10(FAMES.HM.Data[3:31])

# Convert infinite values to 0
for (col in names(FAMES.HM.Data.Normal)) {
  FAMES.HM.Data.Normal[[col]][!is.finite(FAMES.HM.Data.Normal[[col]])] <- 0
}

skimmed_FAMES.normal <- skim_to_wide(FAMES.HM.Data.Normal)
skimmed_FAMES.normal

# check Skewness
skewness(FAMES.HM.Data.Normal)
FAMES.HM.Data.Normal <- cbind(FAMES.HM.Data[1:2], FAMES.HM.Data.Normal)
